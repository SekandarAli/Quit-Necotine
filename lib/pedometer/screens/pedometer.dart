...
import '../../Screens/Components/backButton.dart';
        ...
        body: Center(
          child: Column(
            ...
            children: <Widget>[
              Text(
                'Steps taken:',
                style: TextStyle(fontSize: 30,color: kSignupColor),
              ),
              Text(
                _steps,
                style: TextStyle(fontSize: 60,color: kSigninColor),
              ),
              Divider(
                height: 100,
                thickness: 0,
              ...
              Center(
                child: Text(
                  ...
                  style: _status == 'walking' || _status == 'stopped'
                      ...
                      : TextStyle(fontSize: 20, color: kSigninColor),
                ),
              )
            ],
          ),
